...
//$last_name = $birth_date = $address_number = $address_street = $postal_code = $city = $number_of_kids = $marital_status = "";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php "<form action='update-customer.php?id=" . $customer_id . "' method='post'>"; ?>" method="post">
